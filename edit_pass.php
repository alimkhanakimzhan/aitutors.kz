...
<body>
	...
	<form action="change_pass.php" method="POST" class="form_df1">
		<div class="input_and_text edit_pass">
				<p class="user_headers">Новый пароль:</p>
				<input class="input__edited" type="password" name="password" placeholder="Не менее 8 символов">

		</div>
		<div class="input_and_text edit_pass">
				<p class="user_headers">Подтвердите пароль:</p>
				<input class="input__edited" type="password" name="confirmpassword" placeholder="Подтвердите пароль">
				
		</div>
		<?php 
	if(isset($_SESSION['confirm'])){
		echo '<p class="confirm">' . $_SESSION['confirm'] . '</p>';
	}
